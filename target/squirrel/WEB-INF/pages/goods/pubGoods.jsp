        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../goods/publishGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    <h1 style="margin-left: 0px;text-align: center;">发布物品</h1>
                    <hr/>
                    ...
                    <div class="changeinfo" id="dir">
                        ...
                        <div class="sha">
                            <div class="publ">
                                <textarea  name="describle" class="emoji-wysiwyg-editor" placeholder="请输入描述"></textarea>
                            </div>
                        </div>
                    </div>
                    <br/>
