        ...
        <div id="user_nav">
            <div class="user_info">
                ...
                <span class="btn" data-toggle="modal" data-target="#myModal"
                      style="width: 98%;background-color:#cde3a5; color:rgba(255, 255, 255, 1);margin-top:0.5cm;">
        ...
        <div id="user_content">
            <div class="basic">
                <form:form action="../../goods/editGoodsSubmit" method="post" role="form" enctype="multipart/form-data">
                    <h1 style="margin-left: 0px;text-align: center;">修改物品信息</h1>
                    <hr/>
                    ...
                    <div class="changeinfo" id="dir">
                        ...
                        <div class="sha">
                            <div class="publ">
                                <textarea  name="describle" class="emoji-wysiwyg-editor"
                                       value="${goodsExtend.goods.describle}" placeholder="请输入物品描述">
                                </textarea>
                            </div>
                        </div>
                    </div>
